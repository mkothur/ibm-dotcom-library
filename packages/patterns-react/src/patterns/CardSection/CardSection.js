 ...
 */
const CardSection = ({ theme, cardsGroup }) => {
  useLayoutEffect(() => {
  ...
  // const setComp = cardType => {
  //   console.log('SetComp', cardType);
  //   let Component
  //   if(cardType === 'simpleCards') { return  Component = CardsWithoutImagesGroup; }
  //   else if (cardType === 'imageCards') { return  Component = CardsWithImagesGroup; }
  // }
...
const _renderCardsGroup = (theme, cardsGroup) => {
  return cardsGroup.map(group => {
    console.log('SetComp', group.type);
    // { setComp(group.type) }
    let Component;
